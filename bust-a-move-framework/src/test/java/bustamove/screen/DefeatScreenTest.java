...
public class DefeatScreenTest {
    ...
    @Test
    public void testDefeatScreenInit() throws SlickException {
    	when(game.getWidth()).thenReturn(500);
    	when(font.getWidth("")).thenReturn(50);
    	screen = new DefeatScreen();    	
    ...
    @Test
    public void testDefeatSCreenID() throws SlickException {
    	screen = new DefeatScreen();    	
    	int id = screen.getID();
    	assertThat("ID should be as expected", id, equalTo(GameState.DEFEAT_SCREEN));
    }
}
