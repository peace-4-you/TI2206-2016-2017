...
public class VictoryScreenTest {
    ...
    @Test
    public void testVictoryScreenInit() throws SlickException {
    ...
    @Test
    public void testVictoryScreenID() throws SlickException {
    	screen = new VictoryScreen();    	
    	int id = screen.getID();
    	assertThat("ID should be as expected", id, equalTo(GameState.WIN_SCREEN));
    }    
}