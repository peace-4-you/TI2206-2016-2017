package nl.tudelft.bust_a_move20162017.bust_a_move_framework.graph;
...
* */
import nl.tudelft.bust_a_move20162017.bust_a_move_framework.graph.doublyLinkedList.DLLNode;
import nl.tudelft.bust_a_move20162017.bust_a_move_framework.graph.doublyLinkedList.DoublyLinkedList;
import nl.tudelft.bust_a_move20162017.bust_a_move_framework.graph.doublyLinkedList.NodeIterator;
...
public class Graph <E,T> {
	...
	public Vertex<E,T>[] BFS(Vertex<E,T> vertex){
		...
		DoublyLinkedList<Vertex<E,T>> BFS_list = new DoublyLinkedList<Vertex<E,T>>();
	...
	public Vertex<E,T>[] DFS(Vertex<E,T> vertex){
		...
		// Create the list to store the vertices
		DoublyLinkedList<Vertex<E,T>> DFS_list = new DoublyLinkedList<Vertex<E,T>>();
	...
	public void dijkstra(Vertex<E,T> v){
		...
		PriorityQueue<Vertex<E,T>> pq = new PriorityQueue<Vertex<E,T>>();
	...
	public Edge<E,T>[] dijkstra(Vertex<E,T> vFrom, Vertex<E,T> vTo){
		this.dijkstra(vFrom);
		Stack<Edge<E,T>> path = new Stack<Edge<E,T>>();
